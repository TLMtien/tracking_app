...
def export_rawdata(campainID, all_outlet, from_date, to_date):
    ...
    if campainID == 1:
        ...
        colums = ['Null', 'Date', 'Province', 'Outlet ID', 'Type', 'Area', 'Address', 'Outlet name', 'Brand Volume Sales', 'HVN Volume Sales', 'Compertion Volume Sales', 'Total Table', 'Brand Table', 'HVN Table', 'Other Beer Table','Other Table', '%Table Share', 'Total Consumers', 'No.Consumers Approached', '% Consumers Reach', 'No. Consumers Bought', '%Conversion','Ly 30cl','Voucher beer', 'Festive Box', 'Túi du lịch Tiger', 'Loa Tiger', 'Ví Tiger ', 'Iphone 13','Ly 30cl','Voucher beer', 'Festive Box', 'Túi du lịch Tiger', 'Loa Tiger', 'Ví Tiger ', 'Iphone 13','Ly 30cl','Voucher beer', 'Festive Box', 'Túi du lịch Tiger', 'Loa Tiger', 'Ví Tiger ', 'Iphone 13']
        ...
        colums = ['Null', 'Date', 'Province', 'Outlet ID', 'Type', 'Area', 'Address', 'Outlet name', 'Brand Volume Sales', 'HVN Volume Sales', 'Compertion Volume Sales', 'Total Table', 'Brand Table', 'HVN Table', 'Other Beer Table','Other Table', '%Table Share', 'Total Consumers', 'No.Consumers Approached', '% Consumers Reach', 'No. Consumers Bought', '%Conversion', 'Nón Strongbow', 'Túi Jute Bag', 'Túi Canvas ', 'Dù SB', 'Nón Strongbow', 'Túi Jute Bag', 'Túi Canvas ', 'Dù SB', 'Nón Strongbow', 'Túi Jute Bag', 'Túi Canvas ', 'Dù SB']
                ...
                if rp_table.exists() or rp_sale.exists() or list_gift_rp.exists():
                    if not SP.outlet in List_outlet: 
                        ...
                        for gift_rp in list_gift_rp:
                            ...
                            total_gift1_remaining = gift_rp.gift1_remaining
                            total_gift2_remaining = gift_rp.gift2_remaining
                            total_gift3_remaining = gift_rp.gift3_remaining
                            total_gift4_remaining = gift_rp.gift4_remaining
                            total_gift5_remaining = gift_rp.gift5_remaining

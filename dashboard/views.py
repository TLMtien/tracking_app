        ...
        for SP in sale_person:
            ...
            if rp_table.exists():
                if not SP.outlet in List_outlet: 
                    ...
                    #print(List)
                #print(list_name_gift)
        return render(request,'dashboard/raw-data.html', {"cam_id":campainID, 'List_raw_data':List_raw_data, 'list_name_gift':list_name_gift,'list_name_gift1':list_name_gift1, 'list_name_gift2':list_name_gift2, 'list_name_gift3':list_name_gift3, 'list_name_gift4':list_name_gift4, "date_filter":date_filter.strftime("%d-%m-%Y"),"province_filter":province_filter})

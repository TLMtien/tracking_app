    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.CharField(choices=[('tigerTP', 'TAB_TGR'), ('tigerFA', 'FES_TGR'), ('tigerHZA', 'HOT_TGR'), ('heineken', 'TAB_HNK'), ('heineken_hnk', 'SPE_HNK'), ('STB', 'FES_SBW'), ('bivina', 'TAB_BVN'), ('Larue', 'TAB_LRE')], max_length=200)),
            ],
        ),
        migrations.CreateModel(
